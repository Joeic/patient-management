...
public class PatientRequestDTO {
    ...
    public @NotBlank(message = "Date of birt is required") String getDateOfBirth() {
        return dateOfBirth;
    }

    public void setDateOfBirth(@NotBlank(message = "Date of birt is required") String dateOfBirth) {
